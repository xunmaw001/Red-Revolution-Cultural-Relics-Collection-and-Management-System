<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='gongzuo'"  label='工作人员名称' prop="gongzuoName">
               <el-input v-model="ruleForm.gongzuoName"  placeholder='工作人员名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='gongzuo'"  label='工作人员手机号' prop="gongzuoPhone">
               <el-input v-model="ruleForm.gongzuoPhone"  placeholder='工作人员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='gongzuo'"  label='工作人员身份证号' prop="gongzuoIdNumber">
               <el-input v-model="ruleForm.gongzuoIdNumber"  placeholder='工作人员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='gongzuo'" label='工作人员头像' prop="gongzuoPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='gongzuo'"  label='工作人员邮箱' prop="gongzuoEmail">
               <el-input v-model="ruleForm.gongzuoEmail"  placeholder='工作人员邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
|| flag=='gongzuo')"  label="性别" prop="sexTypes">
...
// 注册表 工作人员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.gongzuoName)&& 'gongzuo'==this.flag){
                             this.$message.error('工作人员名称不能为空');
                             return
                         }

                             if( 'gongzuo' ==this.flag && this.ruleForm.gongzuoPhone&&(!isMobile(this.ruleForm.gongzuoPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.gongzuoIdNumber)&& 'gongzuo'==this.flag){
                             this.$message.error('工作人员身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.gongzuoPhoto)&& 'gongzuo'==this.flag){
                             this.$message.error('工作人员头像不能为空');
                             return
                         }

                             if( 'gongzuo' ==this.flag && this.ruleForm.gongzuoEmail&&(!isEmail(this.ruleForm.gongzuoEmail))){
