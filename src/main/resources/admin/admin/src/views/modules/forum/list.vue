...
|| (sessionTable == 'gongzuo' && scope.row.gongzuoId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/hongshegemingwenwu/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.gongzuoId = el.gongzuoId;//---
                            forum.gongzuoName = el.gongzuoName;
                            forum.gongzuoPhone = el.gongzuoPhone;
                            forum.gongzuoIdNumber = el.gongzuoIdNumber;
                            forum.gongzuoPhoto = el.gongzuoPhoto;
                            forum.gongzuoEmail = el.gongzuoEmail;
                            forum.gongzuoDelete = el.gongzuoDelete;
                            forum.insertTime = el.insertTime;
                            forum.createTime = el.createTime;
