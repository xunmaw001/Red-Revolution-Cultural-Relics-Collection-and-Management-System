...
var centerMenu = [
    {
        ...
        name: '文物信息',
        url: '../wenwu/list2.html'
    }
    ,{
        name: '文物收藏',
        url: '../wenwuCollection/list.html'
    }
    ,{
        name: '文物留言',
        url: '../wenwuLiuyan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '文物',
        url: './pages/wenwu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/hongshegemingwenwu/admin/dist/index.html#/login";
