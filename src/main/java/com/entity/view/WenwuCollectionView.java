...
public class WenwuCollectionView extends WenwuCollectionEntity implements Serializable {
	...
	*/
	...
	private String wenwuCollectionValue;
	...
	public WenwuCollectionView() {

	}

	public WenwuCollectionView(WenwuCollectionEntity wenwuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, wenwuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getWenwuCollectionValue() {
		return wenwuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setWenwuCollectionValue(String wenwuCollectionValue) {
		this.wenwuCollectionValue = wenwuCollectionValue;
	}
	...
	public String toString() {
		return "WenwuCollectionView{" +
			", wenwuCollectionValue=" + wenwuCollectionValue +
