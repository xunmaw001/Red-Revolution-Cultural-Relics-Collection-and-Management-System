...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 工作人员
            //级联表
            GongzuoEntity gongzuo = gongzuoService.selectById(forum.getGongzuoId());
            if(gongzuo != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setGongzuoId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("gongzuo_id", forum.getGongzuoId())
...
//                            forumEntity.setGongzuoId(Integer.valueOf(data.get(0)));   //工作人员 要改的
